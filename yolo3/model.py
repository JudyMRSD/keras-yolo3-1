...
def yolo_head(feats, anchors, num_classes, input_shape):
    ...
    print("num classes in model.py", num_classes)
    feats = K.reshape(
...
def preprocess_true_boxes(true_boxes, input_shape, anchors, num_classes):
    ...
    m = true_boxes.shape[0] # number of images
    grid_shapes = [input_shape//{0:32, 1:16, 2:8}[l] for l in range(3)]
    
    print("m, num images", m)#30
    print("grid_shapes", grid_shapes)#[array([130, 130], dtype=int32), array([260, 260], dtype=int32), array([520, 520], dtype=int32)]
    print("anchor_mask", anchor_mask)#[[6, 7, 8], [3, 4, 5], [0, 1, 2]]
    print("num_classes" , num_classes)#1
    y_true = [np.zeros((m,grid_shapes[l][0],grid_shapes[l][1],len(anchor_mask[l]),5+num_classes),
        dtype='float32') for l in range(3)]# (30,130,130,3,6) 
